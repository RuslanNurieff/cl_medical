...
def get_args() -> argparse.Namespace:
    ...
    model_group.add_argument(
        "--model", type=str, help="Name of the algorithm to train"
    )
    model_group.add_argument(
...
if __name__ == "__main__":
    ...
    if args.all:
        ...
        os.system(f"uv run /home/ruslan/cl_medical/static/static/train/train.py --category {args.category} --config_path {full_conf_path} --n_runs {args.n_runs}")